...
char titlewait[]    = POSTVER " Copyright Adrian Aylward 1989, 1990";
...
{   &mhgadg, 500, 198, 64, 13, 0, STRINGRIGHT|LONGINT|RELVERIFY, STRGADGET,
...
{   &mlgadg, 500, 184, 64, 13, 0, STRINGRIGHT|LONGINT|RELVERIFY, STRGADGET,
...
{   &mfgadg, 500, 170, 64, 13, 0, STRINGRIGHT|LONGINT|RELVERIFY, STRGADGET,
...
{   &mvgadg, 388, 198, 40, 13, 0, STRINGRIGHT|LONGINT|RELVERIFY, STRGADGET,
...
{   15, 0, JAM1, 448, 212, NULL, "Htone", &itext23 };
struct IntuiText itext21 =
{   15, 0, JAM1, 448, 198, NULL, "Fonts", &itext22 };
struct IntuiText itext20 =
{   15, 0, JAM1, 448, 184, NULL, "Paths", &itext21 };
struct IntuiText itext19 =
{   15, 0, JAM1, 448, 170, NULL, "VM", &itext20 };
...
struct IntuiText men2item2text = /* Menu strip */
{   7, 0, COMPLEMENT, 0, 0, NULL, "Interrupt", NULL };
struct MenuItem men2item2 =
{   NULL, 0, 40, 200, 11, ITEMTEXT|COMMSEQ|ITEMENABLED|HIGHCOMP,
...
{   struct Message *msg;
    ...
    for (;;)
    {
        ...
        {   switch (((struct IntuiMessage *) msg)->Class)
            {
                /* Make the interactive window the active one */
